...
/******************************************************************************/
#define AI_WINE_MODEL_NAME          "wine"
#define AI_WINE_ORIGIN_MODEL_NAME   "wine_quality_model"

/******************************************************************************/
#define AI_WINE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_WINE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WINE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WINE_IN_NUM        (1)

AI_DEPRECATED
#define AI_WINE_IN \
  ai_wine_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WINE_IN_SIZE { \
  AI_WINE_IN_1_SIZE, \
}
#define AI_WINE_IN_SIZE_BYTES { \
  AI_WINE_IN_1_SIZE_BYTES, \
}
#define AI_WINE_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_WINE_IN_1_CHANNEL     (13)
#define AI_WINE_IN_1_SIZE        (13)
#define AI_WINE_IN_1_SIZE_BYTES  (52)

/******************************************************************************/
#define AI_WINE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_WINE_OUT \
  ai_wine_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WINE_OUT_SIZE { \
  AI_WINE_OUT_1_SIZE, \
}
#define AI_WINE_OUT_SIZE_BYTES { \
  AI_WINE_OUT_1_SIZE_BYTES, \
}
#define AI_WINE_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_WINE_OUT_1_CHANNEL     (1)
#define AI_WINE_OUT_1_SIZE        (1)
#define AI_WINE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_WINE_N_NODES (3)
 ...
 * @ref ai_wine_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_WINE_*
 * defines into file @ref wine.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
